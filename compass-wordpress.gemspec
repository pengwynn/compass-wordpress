...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "wordpress/stylesheets/layouts/2c-l-fixed.sass",
    "wordpress/stylesheets/layouts/2c-r-fixed.sass",
    "wordpress/stylesheets/layouts/3c-fixed.sass",
    "wordpress/stylesheets/layouts/3c-r-fixed-primary.sass",
    "wordpress/stylesheets/layouts/3c-r-fixed.sass",
    "wordpress/stylesheets/styles/18px.sass",
    "wordpress/stylesheets/styles/21px.sass",
    "wordpress/stylesheets/styles/classic.sass",
    "wordpress/stylesheets/styles/default.sass",
    "wordpress/stylesheets/styles/images.sass",
    "wordpress/stylesheets/styles/plugins.sass",
    "wordpress/stylesheets/styles/reset.sass",
    "wordpress/stylesheets/styles/typography.sass",
